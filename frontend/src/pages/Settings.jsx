...
function SettingsForm({ initial, refresh, navigate }) {
  ...
  return <>
    ...
    <div className="settings-grid">
        ...
        <Card title="Fleet deployment"><div className="placeholder-feature"><span><Icon name="pin" size={28}/></span><div><h3>Service assignment planning</h3><p>Review daily LRV duties, service withdrawals and replacement options when operational planning requires it.</p><button className="button button-secondary button-small" onClick={() => navigate('deployment')}>Open fleet deployment</button></div></div></Card>
